...
vector<sfv_t> kmeans_clustering_method::get_k_center() const {
  return kcenters_;
}
...
sfv_t kmeans_clustering_method::get_nearest_center(const sfv_t& point) const {
