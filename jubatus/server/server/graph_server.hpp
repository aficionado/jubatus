 ...
 public:
  explicit graph(double timeout_sec) : rpc_server(timeout_sec) {
    ...
    rpc_server::add<bool(std::string, std::string)>("remove_node",
         pfi::lang::bind(&Impl::remove_node, impl, pfi::lang::_2));
    ...
    rpc_server::add<bool(std::string, jubatus::core::graph::preset_query)>(
        ...
        &Impl::add_shortest_path_query, impl, pfi::lang::_2));
    rpc_server::add<bool(std::string, jubatus::core::graph::preset_query)>(
        "remove_centrality_query", pfi::lang::bind(
        &Impl::remove_centrality_query, impl, pfi::lang::_2));
    rpc_server::add<bool(std::string, jubatus::core::graph::preset_query)>(
        "remove_shortest_path_query", pfi::lang::bind(
        &Impl::remove_shortest_path_query, impl, pfi::lang::_2));
    ...
    rpc_server::add<jubatus::core::graph::node_info(std::string, std::string)>(
        "get_node", pfi::lang::bind(&Impl::get_node, impl, pfi::lang::_2));
    rpc_server::add<edge(std::string, std::string, uint64_t)>("get_edge",
         pfi::lang::bind(&Impl::get_edge, impl, pfi::lang::_2, pfi::lang::_3));
    ...
    rpc_server::add<bool(std::string, std::string)>("create_node_here",
         pfi::lang::bind(&Impl::create_node_here, impl, pfi::lang::_2));
    rpc_server::add<bool(std::string, std::string)>("remove_global_node",
         pfi::lang::bind(&Impl::remove_global_node, impl, pfi::lang::_2));
    rpc_server::add<bool(std::string, uint64_t, edge)>("create_edge_here",
         pfi::lang::bind(&Impl::create_edge_here, impl, pfi::lang::_2,
         pfi::lang::_3));
  }
};
