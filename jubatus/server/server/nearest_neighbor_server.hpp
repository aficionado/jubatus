 ...
 public:
  explicit nearest_neighbor(double timeout_sec) : rpc_server(timeout_sec) {
    ...
    rpc_server::add<std::vector<std::pair<std::string, float> >(std::string,
         ...
         pfi::lang::bind(&Impl::similar_row_from_data, impl, pfi::lang::_2,
         pfi::lang::_3));
